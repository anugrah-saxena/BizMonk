...
<form id="form1" name="form1" method="post" action="register_action2.php " onSubmit="return finalchek();" , enctype="multipart/form-data">
  <label>
  <div align="center">
    <p>&nbsp;</p>
    <h2 >Contribute In Building Our Database!</h2>
...
<div> <label>Company Market: </label> <select name="5" id="5">
      <option value="farmer">SERVICES</option>      
...
<div> <label>City: </label> <select name="7" id="7">
      ...
      <option value="bangalore">BANGALORE</option>
        ...
        <option value="City">FIND FOR ME</option>
